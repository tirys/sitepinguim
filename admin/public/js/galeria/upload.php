...
*/
require "fineuploader".DS."fineuploader.php";

if(isset($_GET['id']))
{
	$filename = $_GET['nome'].'_'.md5(uniqid()).'__'.$_GET['d_g'].'__'.$_GET['d_p'];
}
...
$result = $uploader->handleUpload(UPLOAD_DIR, false, $filename); //handleUpload($uploadDirectory, $replaceOldFile=FALSE, $filename='')
