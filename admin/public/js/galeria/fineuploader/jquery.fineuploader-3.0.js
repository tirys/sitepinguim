...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        text: {
            uploadButton: 'Selecione',
            cancelButton: 'Cancelar',
            retryButton: 'De novo',
            failUpload: 'Upload falho',
            dragZone: 'Arraste aqui para upload',
        ...
        messages: {
            tooManyFilesError: "Voce so pode arrastar um arquivo"
        },
        retry: {
            showAutoRetryNote: true,
            autoRetryNote: "Retomando {retryNum}/{maxAuto}...",
            showButton: false
        },
